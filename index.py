...
if  'id' in form:
    ...
    message_action='''
      <form action="process_message.py" method="post">
        <input type="text" style="width:90%; font-size:280%" name="num_name">
        <input type="text" style="width:90%; font-size:280%" name="message">
        <input type="submit" value="send" style="width:17%; height:60px; font-size:280%">
      </form>
    '''
...
<body>
    ...
    <div style="margin:12%; background-color: rgb(186, 210, 218);">
      <h1 style="text-align: center;"><div style="color:rgb(87, 122, 205);font-size:280%">한민 위키</div>
      <div style="color:rgb(139, 83, 236);font-size:160%">한민고 전용 위키피디아</div></h1>
    </div>
    <br>
    <br>
